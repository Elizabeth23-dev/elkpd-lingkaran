...
export const soalPerTopik: Record<string, SoalItem[]> = {
  'lingkaran-busur': [
    ...
    },
    {
      ...
      pertanyaan: 'Sebuah jam dinding berbentuk lingkaran dengan jari-jari 21 cm. Jarum jam menunjukkan pukul 03.00.\n\na. Berapa besar sudut pusat yang dibentuk kedua jarum jam pada pukul 03.00?\n\nb. Hitunglah panjang busur yang dihadapi sudut pusat tersebut! (π = 22/7)\n\nc. Hitunglah luas juring yang terbentuk! (π = 22/7)\n\nd. Jelaskan apa perbedaan antara busur dan juring dalam konteks soal ini!\n\ne. Jika jarum jam menunjukkan pukul 06.00 (sudut pusat = 180°), berapakah panjang busur dan luas juring yang baru?',
      pilihan: [],
      jawabanBenar: -1,
      penjelasan: '(a) Pukul 03.00 → jarum jam besar di 12 dan jarum kecil di 3. Sudut pusat = 90°.\n(b) Panjang busur = (90/360) × 2 × (22/7) × 21 = (1/4) × 132 = 33 cm.\n(c) Luas juring = (90/360) × (22/7) × 441 = (1/4) × 1386 = 346,5 cm².\n(d) Busur adalah garis lengkung (bagian dari keliling), sedangkan juring adalah daerah/luas yang dibatasi dua jari-jari dan busur — seperti potongan pizza.\n(e) Panjang busur = (180/360) × 132 = 66 cm. Luas juring = (180/360) × 1386 = 693 cm².',
      kesulitan: 'sulit',
      skor: 25,
      waktu: 480,
    },
  ...
  'lingkaran-garis-singgung': [
    ...
    },
    {
      id: 22,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Dari titik P di luar lingkaran berpusat O berjari-jari 5 cm, ditarik dua garis singgung PA dan PB. Diketahui OP = 13 cm.\n\na. Mengapa garis PA dan PB disebut garis singgung? Apa syaratnya?\n\nb. Sifat atau teorema apa yang digunakan untuk menghitung panjang garis singgung dari titik luar?\n\nc. Hitunglah panjang PA! (Gunakan teorema Pythagoras)\n\nd. Seorang teman menyatakan PB lebih pendek dari PA karena posisi titik singgung B berbeda. Apakah benar? Jelaskan dengan alasan matematis!\n\ne. Mengapa dari titik yang berada di dalam lingkaran tidak bisa ditarik garis singgung? Jelaskan secara singkat!',
      pilihan: [],
      jawabanBenar: -1,
      penjelasan: '(a) PA dan PB disebut garis singgung karena masing-masing hanya menyentuh lingkaran di satu titik (A dan B) dan tegak lurus dengan jari-jari di titik tersebut (∠OAP = ∠OBP = 90°).\n(b) Sifat garis singgung ⊥ jari-jari, lalu gunakan teorema Pythagoras: PT² = OP² − r².\n(c) PA² = OP² − OA² = 13² − 5² = 169 − 25 = 144. PA = 12 cm.\n(d) Pendapat teman SALAH. Dua garis singgung dari satu titik luar selalu sama panjang (PA = PB = 12 cm), karena segitiga OAP ≅ OBP berdasarkan kriteria RHS.\n(e) Jika P di dalam lingkaran maka OP < r, sehingga PT² = OP² − r² bernilai negatif → tidak ada panjang nyata → garis singgung tidak mungkin dibuat.',
      kesulitan: 'sulit',
      skor: 25,
      waktu: 480,
    },
  ...
  'definisi-unsur': [
    ...
    },
    {
      id: 22,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Di sekolah terdapat taman berbentuk lingkaran dengan keliling 88 meter. Taman dibagi menjadi 4 bagian: (1) taman bunga, (2) area bermain, (3) jalur pejalan, (4) area duduk, dengan perbandingan luas 3:2:2:1.\n\na. Hitunglah jari-jari taman dari kelilingnya! (π = 22/7)\n\nb. Hitunglah luas total taman! (π = 22/7)\n\nc. Hitunglah luas masing-masing bagian taman berdasarkan perbandingan 3:2:2:1!\n\nd. Berapa besar sudut pusat untuk setiap bagian taman?\n\ne. Menurutmu, apakah pembagian 3:2:2:1 sudah sesuai kebutuhan? Berikan alasanmu dan usulkan perbandingan yang menurutmu lebih baik!',
      pilihan: [],
      jawabanBenar: -1,
      penjelasan: '(a) K = 2πr → 88 = 2 × (22/7) × r → r = 14 m.\n(b) Luas total = (22/7) × 14² = (22/7) × 196 = 616 m².\n(c) Total perbandingan = 3+2+2+1 = 8. Bunga = (3/8)×616 = 231 m². Bermain = (2/8)×616 = 154 m². Jalur = 154 m². Duduk = (1/8)×616 = 77 m².\n(d) Sudut pusat = (proporsi/total) × 360°. Bunga = (3/8)×360° = 135°. Bermain & jalur = 90°. Duduk = 45°.\n(e) Jawaban terbuka. Contoh: area duduk (45°) terlalu sempit jika banyak pengunjung lansia, bisa diusulkan perbandingan 3:2:2:2 agar area duduk lebih lega.',
      kesulitan: 'sulit',
      skor: 25,
      waktu: 480,
    },
