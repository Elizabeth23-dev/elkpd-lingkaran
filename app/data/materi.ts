...
export const soalPerTopik: Record<string, SoalItem[]> = {
  'lingkaran-busur': [
    ...
    },
    {
      ...
      pertanyaan: 'Sebuah jam dinding berbentuk lingkaran dengan jari-jari 21 cm. Jarum jam menunjukkan pukul 03.00.\n\n[Fokus pada Pertanyaan] (a) Apa yang ingin kamu hitung dari situasi jarum jam ini? Identifikasi inti permasalahannya!\n\n[Observasi & Fakta] (b) Data apa saja yang tersedia? Tuliskan semua informasi penting dari soal!\n\n[Membuat Dedukasi] (c) Berdasarkan data tersebut, hitunglah: (1) Besar sudut pusat yang dibentuk kedua jarum, (2) Panjang busur yang dihadapi sudut pusat, dan (3) Luas juring yang terbentuk. Gunakan π = 22/7.\n\n[Memperjelas Konsep] (d) Jelaskan apa yang dimaksud dengan sudut pusat dan juring dalam konteks soal ini!\n\n[Menentukan Tindakan] (e) Jika sudut pusat berubah menjadi 180° (pukul 06.00), bagaimana perubahan panjang busur dan luas juring? Tentukan strategi perhitunganmu!',
      pilihan: [],
      jawabanBenar: -1,
    ...
    },
    {
      id: 22,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Sebuah kue tart berbentuk lingkaran dengan diameter 28 cm dipotong menjadi 8 bagian sama besar. Dua potongan akan digabung menjadi hadiah juara kelas.\n\n[Fokus pada Pertanyaan] (a) Identifikasi apa yang menjadi inti permasalahan dalam pembagian kue ini!\n\n[Menyesuaikan dengan Sumber] (b) Rumus apa yang paling tepat digunakan untuk menghitung luas dan panjang busur tiap potongan? Jelaskan alasanmu memilih rumus tersebut!\n\n[Mempertimbangkan Hasil Induksi] (c) Hitunglah: (1) Besar sudut pusat tiap potongan kecil, (2) Panjang busur 1 potongan kecil, (3) Luas potongan besar (2 potongan digabung). Gunakan π = 22/7.\n\n[Mendefinisikan Istilah] (d) Apa perbedaan antara busur dan juring? Bagian mana dari kue yang merupakan juring?\n\n[Menggunakan Taktik Efektif] (e) Apakah cara pembagian ini adil bagi semua siswa? Berikan argumen logismu disertai data perhitungan!',
      pilihan: [],
      jawabanBenar: -1,
  ...
  'lingkaran-garis-singgung': [
    ...
    },
    {
      id: 21,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Roda sebuah kereta berjari-jari 50 cm menyentuh rel di titik T.\n\n[Fokus pada Pertanyaan] (a) Apa inti pertanyaan dari situasi roda dan rel ini? Jelaskan apa yang perlu dibuktikan!\n\n[Observasi & Fakta] (b) Amati hubungan antara jari-jari OT dan permukaan rel di titik T. Apa yang dapat kamu simpulkan dari pengamatan tersebut?\n\n[Membuat Dedukasi] (c) Mengapa rel hanya menyentuh roda di SATU titik? Gunakan definisi garis singgung untuk mendukung kesimpulanmu!\n\n[Memperjelas Konsep & Asumsi] (d) Apa perbedaan antara garis singgung dan garis potong (sekans)? Jelaskan asumsi mana yang berlaku pada kasus roda dan rel!\n\n[Menentukan Tindakan & Evaluasi] (e) Seorang teman berpendapat bahwa roda dan rel bersentuhan di dua titik agar kereta lebih stabil. Evaluasilah pendapat ini — apakah benar atau salah? Tentukan tindakan paling tepat untuk meluruskan pendapat tersebut!',
      pilihan: [],
      jawabanBenar: -1,
    ...
    },
    {
      id: 22,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Dari titik P di luar lingkaran berpusat O berjari-jari 5 cm, ditarik dua garis singgung PA dan PB. Diketahui OP = 13 cm.\n\n[Fokus pada Pertanyaan] (a) Apa yang ingin dibuktikan atau dihitung dalam soal ini? Tuliskan inti pertanyaannya!\n\n[Menyesuaikan dengan Sumber] (b) Teorema atau sifat apa yang paling relevan digunakan untuk menyelesaikan soal ini? Jelaskan mengapa!\n\n[Membuat Dedukasi & Pertimbangan] (c) Hitunglah panjang PA menggunakan sifat garis singgung dan teorema Pythagoras. Tunjukkan langkah-langkahnya!\n\n[Mempertimbangkan Hasil Induksi] (d) Seorang siswa menyatakan PB lebih pendek dari PA karena posisi titik singgung B berbeda dari A. Dari kasus ini, buat generalisasi: apakah panjang dua garis singgung dari satu titik luar selalu sama? Buktikan secara logis!\n\n[Menggunakan Taktik Efektif] (e) Mengapa dari titik yang berada di dalam lingkaran tidak bisa ditarik garis singgung? Gunakan pendekatan paling efisien untuk menjelaskannya!',
      pilihan: [],
      jawabanBenar: -1,
  ...
  'definisi-unsur': [
    ...
    },
    {
      id: 21,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Sebuah kolam renang berbentuk lingkaran memiliki diameter 14 meter. Di sekeliling kolam akan dipasang keramik selebar 1 meter.\n\n[Fokus pada Pertanyaan] (a) Apa inti permasalahan dalam soal ini? Tuliskan apa saja yang perlu dihitung!\n\n[Observasi & Fakta] (b) Amati situasinya dan tuliskan semua data yang tersedia dari soal. Informasi apa yang paling penting untuk memulai perhitungan?\n\n[Membuat Dedukasi] (c) Berdasarkan data tersebut, hitunglah: (1) Luas kolam tanpa keramik, (2) Luas total area dengan keramik, (3) Luas area keramik saja. Gunakan π = 22/7.\n\n[Memperjelas Konsep] (d) Mengapa jari-jari kolam dengan keramik menjadi 8 m, bukan 15 m? Jelaskan konsep yang mendasari penambahan jari-jari ini!\n\n[Menentukan Tindakan] (e) Jika harga keramik Rp150.000 per m², tentukan total biaya keramik. Jika anggaran hanya Rp6.000.000, taktik apa yang bisa dilakukan agar tetap bisa memasang keramik?',
      pilihan: [],
      jawabanBenar: -1,
    ...
    },
    {
      id: 22,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Di sekolah terdapat taman berbentuk lingkaran dengan keliling 88 meter. Taman dibagi menjadi 4 bagian: (1) taman bunga, (2) area bermain, (3) jalur pejalan, (4) area duduk, dengan perbandingan luas 3:2:2:1.\n\n[Fokus pada Pertanyaan] (a) Identifikasi inti permasalahan. Apa yang perlu ditentukan dari pembagian taman ini?\n\n[Menyesuaikan dengan Sumber] (b) Konsep atau rumus apa yang paling relevan untuk menyelesaikan soal ini? Jelaskan kaitannya dengan konsep juring!\n\n[Membuat Dedukasi & Induksi] (c) Tentukan: (1) jari-jari taman, (2) luas total, (3) luas masing-masing bagian, (4) sudut pusat setiap bagian. Gunakan π = 22/7.\n\n[Mendefinisikan Istilah & Asumsi] (d) Apa yang dimaksud dengan perbandingan luas? Jelaskan asumsi apa yang digunakan saat membagi taman berdasarkan perbandingan ini!\n\n[Menggunakan Taktik Efektif] (e) Dari sudut pandang kebutuhan pengguna taman, evaluasi apakah pembagian 3:2:2:1 sudah efektif. Jika tidak, usulkan perbandingan yang lebih tepat dan jelaskan alasanmu!',
      pilihan: [],
      jawabanBenar: -1,
...
di mana \u03b1 adalah besar sudut pusat (dalam derajat) dan r adalah jari-jari lingkaran.`
    ...
    contoh: [
      {
        soal: 'Sebuah sprinkler (alat penyiram) air berputar membentuk sudut pusat 120° dan menjangkau jarak 14 meter. Seorang petani ingin mengetahui apakah luas lahan yang disiram sudah mencukupi 600 m².\n\n[Elementary Clarification – Fokus pada Pertanyaan] (a) Apa inti permasalahan yang ingin diselesaikan petani? Identifikasi dengan jelas apa yang perlu dihitung!\n\n[Basic Support – Observasi & Fakta] (b) Tuliskan semua data yang tersedia dari situasi sprinkler ini. Data mana yang paling krusial untuk memulai perhitungan?\n\n[Inference – Membuat Dedukasi] (c) Hitunglah: (1) Panjang busur jangkauan sprinkler, (2) Luas juring yang disiram. Gunakan π = 22/7.\n\n[Advanced Clarification – Memperjelas Konsep] (d) Mengapa area yang disiram berbentuk juring, bukan lingkaran penuh? Jelaskan konsep sudut pusat yang mendasarinya!\n\n[Strategy and Tactics – Menentukan Tindakan] (e) Luas yang disiram tidak mencukupi 600 m². Tentukan strategi paling efisien: apakah sudut pusat atau jangkauan (jari-jari) yang perlu ditingkatkan? Berikan alasan matematis!',
        solusi: [
      ...
      {
        soal: 'Pada lingkaran berpusat O, titik A, B, C terletak pada lingkaran. Sudut pusat ∠AOB = 2x + 10° dan sudut keliling ∠ACB = x + 15°, keduanya menghadap busur AB yang sama. Seorang siswa menyimpulkan bahwa x = 20°.\n\n[Elementary Clarification – Menganalisis Argumen] (a) Apa klaim yang dibuat siswa? Identifikasi apakah argumennya mengikuti logika yang tepat!\n\n[Basic Support – Menyesuaikan dengan Sumber] (b) Sifat atau teorema apa yang paling relevan untuk mengevaluasi klaim ini? Jelaskan mengapa sumber ini dapat dipercaya!\n\n[Inference – Membuat Dedukasi] (c) Gunakan sifat yang telah kamu pilih untuk membuktikan apakah x = 20° benar. Tunjukkan langkah-langkahnya!\n\n[Advanced Clarification – Mendefinisikan Istilah] (d) Apa yang dimaksud dengan sudut pusat dan sudut keliling yang "menghadap busur yang sama"? Bagaimana definisi ini memengaruhi persamaan yang dibuat?\n\n[Strategy and Tactics – Menggunakan Taktik Efektif] (e) Metode apa yang paling efisien untuk memverifikasi nilai x? Selesaikan dan verifikasi hasilmu!',
        solusi: [
          '(a) [Elementary Clarification] Klaim siswa: x = 20°. Argumennya perlu diperiksa menggunakan sifat hubungan sudut pusat dan sudut keliling — apakah memenuhi α = 2θ.',
          '(b) [Basic Support] Sifat yang relevan: sudut pusat = 2 × sudut keliling (∠AOB = 2 × ∠ACB). Teorema ini terbukti secara geometris dan berlaku untuk semua busur pada lingkaran yang sama.',
          '(c) [Inference] Gunakan α = 2θ: 2x + 10 = 2(x + 15) → 2x + 10 = 2x + 30 → 10 = 30. Ini kontradiksi! Cek x = 20: ∠AOB = 50°, ∠ACB = 35° → 50 ≠ 2×35 = 70°. Klaim SALAH.',
          '(d) [Advanced Clarification] Sudut pusat titik sudutnya di O (pusat), sudut keliling titik sudutnya di lingkaran (C), keduanya "menghadap busur yang sama" artinya membatasi busur AB yang identik. Definisi ini mensyaratkan ∠AOB = 2∠ACB secara mutlak.',
          '(e) [Strategy and Tactics] Cara efisien: langsung substitusi ke α = 2θ. Karena 2x+10 = 2(x+15) tak memiliki solusi, ekspresi sudut inkonsisten. Soal harus memberikan nilai sudut konkret, bukan dua ekspresi yang saling kontradiksi.',
        ],
      },
    ],
  },
...
Jika dari P ditarik dua garis singgung PA dan PB, maka PA = PB (terbukti dari kongruensi segitiga OAP \u2261 segitiga OBP dengan kriteria siku-siku-miring-sisi / RHS).`,
    ...
    contoh: [
      {
        soal: 'Roda sebuah sepeda berjari-jari 28 cm sedang berjalan di atas jalan yang rata. Di titik T roda menyentuh jalan.\n\n[Elementary Clarification – Fokus pada Pertanyaan] (a) Apa inti pertanyaan dari situasi ini? Apa yang perlu dibuktikan tentang hubungan jalan dan roda?\n\n[Basic Support – Mengobservasi Fakta] (b) Amati situasi roda yang menyentuh jalan. Tuliskan semua fakta geometris yang dapat kamu identifikasi dari titik T!\n\n[Inference – Membuat Dedukasi] (c) Berdasarkan definisi garis singgung, buktikan bahwa jalan berperan sebagai garis singgung terhadap roda. Apa yang terjadi jika jalan memotong roda di dua titik?\n\n[Advanced Clarification – Memperjelas Konsep & Asumsi] (d) Apa perbedaan mendasar antara garis singgung dan garis potong (sekans)? Asumsi geometris mana yang berlaku pada kasus roda dan jalan?\n\n[Strategy and Tactics – Menggunakan Taktik Efektif] (e) Seorang teman berpendapat bahwa roda menyentuh jalan di dua titik agar lebih stabil. Evaluasi pendapat ini secara matematis dan fisik. Tentukan argumen paling efektif untuk meluruskannya!',
        solusi: [
      ...
      {
        soal: 'Dari titik P di luar sebuah lingkaran berpusat O berjari-jari 5 cm, Andi menarik dua garis singgung PA dan PB. Diketahui OP = 13 cm. Andi mengklaim bahwa panjang PA pasti lebih panjang dari PB karena posisi titik singgung A dan B berbeda.\n\n[Elementary Clarification – Menganalisis Argumen] (a) Identifikasi klaim Andi. Apakah argumennya logis? Apa yang perlu dibuktikan untuk mengevaluasi klaim tersebut?\n\n[Basic Support – Menyesuaikan dengan Sumber] (b) Teorema atau sifat garis singgung mana yang paling relevan digunakan di sini? Jelaskan mengapa sumber geometris tersebut dapat diandalkan!\n\n[Inference – Membuat Dedukasi] (c) Hitunglah panjang PA menggunakan sifat garis singgung dan teorema Pythagoras. Tunjukkan langkah-langkahnya secara sistematis!\n\n[Inference – Mempertimbangkan Hasil Induksi] (d) Dari kasus ini, buat generalisasi: apakah dua garis singgung dari satu titik luar selalu sama panjang? Buktikan menggunakan kongruensi segitiga!\n\n[Strategy and Tactics – Menggunakan Taktik Efektif] (e) Mengapa dari titik yang berada di dalam lingkaran tidak bisa ditarik garis singgung? Gunakan rumus PT² = OP² − r² sebagai pendekatan paling efisien!',
        solusi: [
          '(a) [Elementary Clarification] Klaim Andi: PA > PB karena posisi titik singgung berbeda. Argumen ini TIDAK logis — posisi titik singgung tidak menentukan panjang. Yang perlu dibuktikan: PA = PB.',
          '(b) [Basic Support] Sifat paling relevan: garis singgung ⊥ jari-jari di titik singgung (∠OAP = ∠OBP = 90°) dan PA = PB (sifat dua garis singgung dari titik yang sama). Teorema ini berlaku universal dan terbukti melalui kongruensi segitiga.',
          '(c) [Inference] ∠OAP = 90° → segitiga OAP siku-siku di A. PA² = OP² − OA² = 13² − 5² = 169 − 25 = 144. PA = √144 = 12 cm.',
          '(d) [Inference – Induksi] Generalisasi: dua garis singgung dari satu titik luar SELALU sama panjang. Bukti: Segitiga OAP dan OBP memiliki OA = OB = r, OP = OP (bersama), ∠OAP = ∠OBP = 90° → kongruen (RHS) → PA = PB = 12 cm. Klaim Andi SALAH.',
          '(e) [Strategy and Tactics] Gunakan PT² = OP² − r². Jika P di dalam lingkaran, maka OP < r → PT² = OP² − r² < 0 (negatif) → tidak ada nilai PT yang nyata. Kesimpulan: garis singgung dari titik dalam lingkaran tidak mungkin ada.',
        ],
      },
    ],
  },
...
Contoh: Lingkaran dengan jari-jari 7 cm memiliki keliling = 2 \u00d7 (22/7) \u00d7 7 = 44 cm dan luas = (22/7) \u00d7 7\u00b2 = 154 cm\u00b2.`,
    ...
    contoh: [
      {
        soal: 'Sebuah kolam ikan berbentuk lingkaran memiliki keliling 44 m. Pemiliknya ingin membuat jalur pejalan kaki melingkar di luar kolam dengan lebar 2 m, lalu memasang lampu hias setiap 4 m di sepanjang tepian luar jalur tersebut.\n\n[Elementary Clarification – Fokus pada Pertanyaan] (a) Identifikasi semua hal yang perlu dihitung dari situasi kolam dan jalur ini. Apa inti permasalahannya?\n\n[Basic Support – Mengobservasi & Mempertimbangkan Fakta] (b) Tuliskan semua data yang tersedia. Fakta mana yang paling menentukan dalam perhitungan luas jalur?\n\n[Inference – Membuat Dedukasi] (c) Hitunglah: (1) Jari-jari kolam, (2) Luas jalur pejalan kaki, (3) Jumlah lampu hias. Gunakan π = 22/7.\n\n[Advanced Clarification – Memperjelas Konsep] (d) Mengapa luas jalur dihitung sebagai selisih dua lingkaran, bukan hanya keliling dikali lebar? Jelaskan asumsi geometris yang mendasarinya!\n\n[Strategy and Tactics – Menentukan Tindakan] (e) Jika anggaran pembuatan jalur adalah Rp800.000/m², apakah anggaran Rp3.000.000 cukup? Jika tidak, tentukan strategi paling efektif untuk menghemat biaya tanpa menghilangkan fungsi jalur!',
        solusi: [
      ...
      {
        soal: 'Dua pizza berbentuk lingkaran tersedia: Pizza A berdiameter 28 cm seharga Rp84.000, dan Pizza B berdiameter 14 cm seharga Rp25.000. Seorang pelanggan berpendapat bahwa 2 pizza B lebih menguntungkan daripada 1 pizza A karena harganya lebih murah.\n\n[Elementary Clarification – Menganalisis Argumen] (a) Apa klaim pelanggan? Identifikasi logika di balik klaim tersebut dan tentukan apa yang perlu dibuktikan!\n\n[Basic Support – Menyesuaikan dengan Sumber] (b) Rumus atau konsep mana yang paling tepat digunakan untuk membandingkan nilai dua pilihan ini secara objektif? Jelaskan alasanmu!\n\n[Inference – Membuat Dedukasi] (c) Hitunglah luas Pizza A dan Pizza B. Bandingkan luas 2 Pizza B dengan luas 1 Pizza A. Gunakan π = 22/7.\n\n[Inference – Mempertimbangkan Nilai Keputusan] (d) Hitunglah harga per cm² untuk masing-masing pilihan. Berdasarkan data ini, keputusan mana yang paling menguntungkan?\n\n[Strategy and Tactics – Menentukan Tindakan] (e) Apakah pendapat pelanggan benar? Berikan kesimpulan berbasis data dan tentukan rekomendasi pembelian yang paling strategis!',
        solusi: [
          '(a) [Elementary Clarification] Klaim pelanggan: 2 Pizza B lebih menguntungkan karena lebih murah (2×Rp25.000 = Rp50.000 < Rp84.000). Yang perlu dibuktikan: perbandingan nilai (luas per rupiah), bukan sekadar harga.',
          '(b) [Basic Support] Konsep yang tepat: luas lingkaran (L = πr²) dan harga per cm². Perbandingan luas memberikan ukuran jumlah pizza yang sesungguhnya. Harga per cm² adalah indikator nilai yang objektif.',
          '(c) [Inference] Pizza A: r=14 cm, Luas = (22/7)×196 = 616 cm². Pizza B: r=7 cm, Luas = (22/7)×49 = 154 cm². 2 Pizza B = 308 cm². Perbandingan: 1 Pizza A (616 cm²) = 2× luasan 2 Pizza B (308 cm²). Pizza A dua kali lebih besar!',
          '(d) [Inference – Nilai Keputusan] Harga/cm² Pizza A = Rp84.000/616 ≈ Rp136/cm². Harga/cm² dua Pizza B = Rp50.000/308 ≈ Rp162/cm². Pizza A lebih murah per cm² — keputusan yang lebih menguntungkan.',
          '(e) [Strategy and Tactics] Pendapat pelanggan SALAH. 1 Pizza A lebih menguntungkan: luas 2× lebih besar dan harga per cm² lebih murah (Rp136 vs Rp162). Rekomendasi: beli 1 Pizza A jika butuh volume lebih banyak. Beli 2 Pizza B hanya jika perlu dua lokasi penyajian berbeda.',
        ],
      },
    ],
  },
