...
export const soalPerTopik: Record<string, SoalItem[]> = {
  'lingkaran-busur': [
    ...
    },
    {
      ...
      pertanyaan: 'Sebuah sprinkler (alat penyiram) air berputar membentuk sudut pusat 90° dan menjangkau jarak 21 meter. Seorang petani ingin mengetahui apakah luas lahan yang disiram sudah mencukupi 400 m².\n\na. Identifikasi semua hal yang perlu dihitung dari situasi sprinkler ini. Apa inti permasalahannya?\n\nb. Tuliskan semua data yang tersedia. Fakta mana yang paling menentukan dalam menghitung luas lahan yang disiram?\n\nc. Hitunglah: (1) Panjang busur jangkauan sprinkler, (2) Luas juring (luas lahan yang disiram). Gunakan π = 22/7.\n\nd. Mengapa luas area yang disiram dihitung sebagai luas juring, bukan luas lingkaran penuh atau hanya sepanjang busur? Jelaskan asumsi geometris yang mendasarinya!\n\ne. Apakah luas yang disiram sudah mencukupi 400 m²? Jika belum, mana yang lebih efektif ditingkatkan: sudut pusat atau jari-jari (jangkauan)? Berikan alasan matematisnya!',
      pilihan: [],
      jawabanBenar: -1,
      penjelasan: '(a) Hal yang perlu dihitung: (1) Panjang busur jangkauan sprinkler, (2) Luas juring/lahan yang disiram. Inti permasalahannya: menentukan apakah area berbentuk juring yang disapu sprinkler dengan sudut dan jangkauan tertentu memiliki luas mencukupi target petani.\n(b) Data: sudut pusat α = 90°, jari-jari r = 21 m, target = 400 m², π = 22/7. Fakta paling menentukan: jari-jari r — karena luas juring berbanding kuadrat dengan r (L ∝ r²), perubahan kecil pada r berpengaruh besar terhadap luas.\n(c) (1) l = (α/360°) × 2πr = (90/360) × 2 × (22/7) × 21 = (1/4) × 132 = 33 m. (2) L = (α/360°) × πr² = (90/360) × (22/7) × 21² = (1/4) × 1386 = 346,5 m².\n(d) Sprinkler berputar dari satu titik tetap (pusat) hanya pada rentang sudut 90°, bukan putaran penuh 360°. Asumsi geometris: pancaran air seragam ke segala arah dalam rentang sudut itu dan jangkauan = jari-jari. Sehingga area yang tersiram dibatasi oleh dua jari-jari dan satu busur — itulah definisi juring. Bukan busur (busur hanya kurva, tidak punya luas) maupun lingkaran penuh (perlu sudut pusat 360°).\n(e) 346,5 m² < 400 m² → BELUM mencukupi. Meningkatkan jari-jari lebih efektif daripada sudut pusat. Alasan matematis: L ∝ r² (kuadratik) tapi L ∝ α (linear). Contoh: r dinaikkan menjadi 28 m → L = (1/4) × (22/7) × 784 = 616 m². Sedangkan α dinaikkan menjadi 120° → L = (1/3) × (22/7) × 441 = 462 m². Kenaikan r memberi dampak lebih besar.',
      kesulitan: 'sulit',
      skor: 25,
      waktu: 600,
    },
    {
      id: 22,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Sebuah sprinkler (alat penyiram) air berputar membentuk sudut pusat 60° dan menjangkau jarak 42 meter. Seorang petani ingin mengetahui apakah luas lahan yang disiram sudah mencukupi 800 m².\n\na. Identifikasi semua hal yang perlu dihitung dari situasi sprinkler ini. Apa inti permasalahannya?\n\nb. Tuliskan semua data yang tersedia. Fakta mana yang paling menentukan dalam menghitung luas lahan yang disiram?\n\nc. Hitunglah: (1) Panjang busur jangkauan sprinkler, (2) Luas juring (luas lahan yang disiram). Gunakan π = 22/7.\n\nd. Mengapa luas area yang disiram dihitung sebagai luas juring, bukan luas lingkaran penuh atau hanya sepanjang busur? Jelaskan asumsi geometris yang mendasarinya!\n\ne. Apakah luas yang disiram sudah mencukupi 800 m²? Jika belum, mana yang lebih efektif ditingkatkan: sudut pusat atau jari-jari (jangkauan)? Berikan alasan matematisnya!',
      pilihan: [],
      jawabanBenar: -1,
      penjelasan: '(a) Hal yang perlu dihitung: (1) Panjang busur jangkauan sprinkler, (2) Luas juring/lahan yang disiram. Inti permasalahannya: menentukan apakah area berbentuk juring yang disapu sprinkler dengan sudut dan jangkauan tertentu memiliki luas mencukupi target petani.\n(b) Data: sudut pusat α = 60°, jari-jari r = 42 m, target = 800 m², π = 22/7. Fakta paling menentukan: jari-jari r — karena luas juring berbanding kuadrat dengan r (L ∝ r²), perubahan kecil pada r berpengaruh besar terhadap luas.\n(c) (1) l = (α/360°) × 2πr = (60/360) × 2 × (22/7) × 42 = (1/6) × 264 = 44 m. (2) L = (α/360°) × πr² = (60/360) × (22/7) × 42² = (1/6) × 5544 = 924 m².\n(d) Sprinkler berputar dari satu titik tetap (pusat) hanya pada rentang sudut 60°, bukan putaran penuh 360°. Asumsi geometris: pancaran air seragam ke segala arah dalam rentang sudut itu dan jangkauan = jari-jari. Sehingga area yang tersiram dibatasi oleh dua jari-jari dan satu busur — itulah definisi juring. Bukan busur (busur hanya kurva, tidak punya luas) maupun lingkaran penuh (perlu sudut pusat 360°).\n(e) 924 m² > 800 m² → SUDAH mencukupi. Meskipun demikian, jika suatu saat target diperbesar, meningkatkan jari-jari lebih efektif daripada sudut pusat. Alasan matematis: L ∝ r² (kuadratik) tapi L ∝ α (linear). Contoh: r dinaikkan menjadi 56 m → L = (1/6) × (22/7) × 3136 ≈ 1642,67 m². Sedangkan α dinaikkan menjadi 80° → L = (80/360) × (22/7) × 1764 = 1232 m². Kenaikan r memberi dampak lebih besar.',
      kesulitan: 'sulit',
      skor: 25,
      waktu: 600,
    },
...
di mana \u03b1 adalah besar sudut pusat (dalam derajat) dan r adalah jari-jari lingkaran.`
    ...
    contoh: [
      {
        soal: 'Sebuah sprinkler (alat penyiram) air berputar membentuk sudut pusat 120° dan menjangkau jarak 14 meter. Seorang petani ingin mengetahui apakah luas lahan yang disiram sudah mencukupi 600 m².\n\na. Identifikasi semua hal yang perlu dihitung dari situasi sprinkler ini. Apa inti permasalahannya?\n\nb. Tuliskan semua data yang tersedia. Fakta mana yang paling menentukan dalam menghitung luas lahan yang disiram?\n\nc. Hitunglah: (1) Panjang busur jangkauan sprinkler, (2) Luas juring (luas lahan yang disiram). Gunakan π = 22/7.\n\nd. Mengapa luas area yang disiram dihitung sebagai luas juring, bukan luas lingkaran penuh atau hanya sepanjang busur? Jelaskan asumsi geometris yang mendasarinya!\n\ne. Apakah luas yang disiram sudah mencukupi 600 m²? Jika belum, mana yang lebih efektif ditingkatkan: sudut pusat atau jari-jari (jangkauan)? Berikan alasan matematisnya!',
        solusi: [
          '(a) Hal yang perlu dihitung: (1) Panjang busur jangkauan sprinkler, (2) Luas juring/lahan yang disiram. Inti permasalahannya: menentukan apakah area berbentuk juring yang disapu sprinkler dengan sudut putar dan jangkauan air tertentu memiliki luas mencukupi target petani.',
          '(b) Data: sudut pusat α = 120°, jari-jari r = 14 m, target = 600 m², π = 22/7. Fakta paling menentukan: jari-jari r — karena luas juring berbanding kuadrat dengan r (L ∝ r²), sehingga perubahan kecil pada r berpengaruh besar terhadap luas.',
          '(c) (1) l = (α/360°) × 2πr = (120/360) × 2 × (22/7) × 14 = (1/3) × 88 = 29,33 m. (2) L = (α/360°) × πr² = (120/360) × (22/7) × 14² = (1/3) × 616 = 205,33 m².',
          '(d) Sprinkler berputar dari satu titik tetap (pusat) hanya pada rentang sudut 120°, bukan putaran penuh 360°. Asumsi geometris: pancaran air seragam ke segala arah dalam rentang sudut itu dan jangkauan = jari-jari. Sehingga area yang tersiram dibatasi oleh dua jari-jari dan satu busur — itulah definisi juring. Bukan busur (busur hanya kurva, tidak punya luas) maupun lingkaran penuh (perlu sudut pusat 360°).',
          '(e) 205,33 m² < 600 m² → BELUM mencukupi. Meningkatkan jari-jari lebih efektif daripada sudut pusat. Alasan matematis: L ∝ r² (kuadratik) tapi L ∝ α (linear). Contoh: r dinaikkan menjadi 21 m → L = (1/3) × (22/7) × 441 = 462 m². Sedangkan α dinaikkan menjadi 240° → L = (240/360) × (22/7) × 196 = 410,67 m². Kenaikan r memberi dampak lebih besar.'
        ],
      },
    ],
  },
