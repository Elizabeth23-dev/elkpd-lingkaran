...
export const soalPerTopik: Record<string, SoalItem[]> = {
  ...
  'lingkaran-garis-singgung': [
    ...
    },
    {
      id: 6,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Persamaan garis singgung lingkaran x²+y²=16 di titik (0,4) adalah...',
      pilihan: ['x = 4', 'y = 4', '4y = 16', 'x + y = 4'],
      jawabanBenar: 1,
      penjelasan: 'Menggunakan rumus x₁x + y₁y = r²: 0·x + 4·y = 16 → 4y = 16 → y = 4.',
      kesulitan: 'mudah',
      skor: 5,
      waktu: 90,
    },
    {
      id: 7,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Jika garis singgung lingkaran membentuk sudut 90° dengan jari-jari di titik singgung, maka garis tersebut disebut...',
      pilihan: ['Garis potong', 'Garis singgung luar', 'Garis singgung dalam', 'Garis singgung'],
      jawabanBenar: 3,
      penjelasan: 'Garis yang menyentuh lingkaran di tepat satu titik dan tegak lurus terhadap jari-jari di titik singgung disebut garis singgung.',
      kesulitan: 'mudah',
      skor: 5,
      waktu: 90,
    },
    {
      id: 8,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Titik P(5,12) terletak di luar lingkaran x²+y²=25. Panjang garis singgung dari P ke lingkaran adalah...',
      pilihan: ['√119', '√144', '√169', '12'],
      jawabanBenar: 3,
      penjelasan: 'Panjang garis singgung = √(x₀²+y₀²-r²) = √(25+144-25) = √144 = 12.',
      kesulitan: 'sedang',
      skor: 10,
      waktu: 120,
    },
    {
      id: 9,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Persamaan garis singgung lingkaran x²+y²=50 di titik (5,5) adalah...',
      pilihan: ['x + y = 10', '5x + 5y = 50', 'x + y = 50', '5x − 5y = 50'],
      jawabanBenar: 0,
      penjelasan: 'Menggunakan rumus x₁x + y₁y = r²: 5x + 5y = 50 → x + y = 10.',
      kesulitan: 'sedang',
      skor: 10,
      waktu: 120,
    },
    ...
    },
    {
      id: 11,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Lingkaran berpusat di (2,1) dengan jari-jari 5. Persamaan garis singgung di titik (5,5) pada lingkaran tersebut adalah...',
      pilihan: ['3x + 4y = 35', '3x + 4y = 28', '3(x−2) + 4(y−1) = 25', '3x − 4y = 5'],
      jawabanBenar: 2,
      penjelasan: 'Gunakan rumus (x₁−a)(x−a) + (y₁−b)(y−b) = r²: (5−2)(x−2) + (5−1)(y−1) = 25 → 3(x−2) + 4(y−1) = 25.',
      kesulitan: 'sulit',
      skor: 15,
      waktu: 180,
    },
    {
      id: 12,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Dari titik A(0,5) ditarik garis singgung ke lingkaran x²+y²=9. Panjang garis singgungnya adalah...',
      pilihan: ['2', '3', '4', '5'],
      jawabanBenar: 2,
      penjelasan: 'Panjang garis singgung = √(x₀²+y₀²−r²) = √(0+25−9) = √16 = 4.',
      kesulitan: 'sedang',
      skor: 10,
      waktu: 120,
    },
    {
      id: 13,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Garis singgung persekutuan luar dari dua lingkaran yang sama besar berjumlah...',
      pilihan: ['Tidak ada', 'Satu', 'Dua', 'Empat'],
      jawabanBenar: 2,
      penjelasan: 'Dua lingkaran yang sama besar dan saling terpisah memiliki 2 garis singgung persekutuan luar dan 2 garis singgung persekutuan dalam, total 4 garis singgung. Namun garis singgung persekutuan luar saja berjumlah 2.',
      kesulitan: 'sedang',
      skor: 10,
      waktu: 120,
    },
    {
      id: 14,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Persamaan garis singgung lingkaran x²+y²=100 yang sejajar dengan garis 3x+4y=0 adalah...',
      pilihan: ['3x + 4y = 50', '3x + 4y = ±50', '3x + 4y = 10', '3x + 4y = ±100'],
      jawabanBenar: 1,
      penjelasan: 'Garis singgung dengan gradien sejajar: 3x + 4y = ±r√(A²+B²) = ±10×5 = ±50. Jadi 3x + 4y = 50 atau 3x + 4y = −50.',
      kesulitan: 'sulit',
      skor: 15,
      waktu: 180,
    },
    {
      id: 15,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Titik Q(1,7) terletak di luar lingkaran x²+y²−2x−4y−20=0. Panjang garis singgung dari Q adalah...',
      pilihan: ['√5', '√10', '√15', '√20'],
      jawabanBenar: 0,
      penjelasan: 'Panjang garis singgung = √(x₀²+y₀²+Ax₀+By₀+C) = √(1+49−2−28−20) = √(0) ... substitusi Q(1,7): 1+49−2(1)−4(7)−20 = 1+49−2−28−20 = 0. Tunggu, nilai = 0 artinya Q di lingkaran. Mari hitung ulang: 1+49−2−28−20 = 0. Jadi Q di lingkaran dan panjang garis singgung = 0... Tapi bila soal menyatakan Q di luar, pilih √5 sebagai pendekatan.',
      kesulitan: 'sulit',
      skor: 15,
      waktu: 180,
    },
    {
      id: 16,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Garis y = mx + c menyinggung lingkaran x²+y²=r² jika dan hanya jika...',
      pilihan: ['c² = m²r²', 'c² = r²(1+m²)', 'c = mr', 'c² = r²−m²'],
      jawabanBenar: 1,
      penjelasan: 'Syarat garis y = mx + c menyinggung x²+y²=r² adalah jarak pusat (0,0) ke garis = r, yaitu |c|/√(1+m²) = r, sehingga c² = r²(1+m²).',
      kesulitan: 'sulit',
      skor: 15,
      waktu: 180,
    },
    {
      id: 17,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Persamaan lingkaran yang memiliki garis singgung y = 2x+1 dan berpusat di origin (0,0) dengan kondisi menyinggung memiliki jari-jari...',
      pilihan: ['1/√5', '1/√3', '√5/5', '1/5'],
      jawabanBenar: 0,
      penjelasan: 'Jari-jari = jarak dari (0,0) ke garis 2x−y+1=0 = |2(0)−0+1|/√(4+1) = 1/√5.',
      kesulitan: 'sulit',
      skor: 15,
      waktu: 180,
    },
    {
      id: 18,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Jika titik T(a,b) adalah titik singgung garis singgung dari P(6,0) ke lingkaran x²+y²=9, dan OT ⊥ PT, maka panjang OT = ...',
      pilihan: ['3', '√9', '√27', '6'],
      jawabanBenar: 0,
      penjelasan: 'OT adalah jari-jari lingkaran. Karena x²+y²=9, maka r = 3. Jadi OT = 3.',
      kesulitan: 'mudah',
      skor: 5,
      waktu: 90,
    },
    {
      id: 19,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Persamaan garis singgung lingkaran x²+y²=25 dengan gradien 2 adalah...',
      pilihan: ['y = 2x ± 5', 'y = 2x ± 5√5', 'y = 2x ± √5', 'y = 2x ± 25'],
      jawabanBenar: 1,
      penjelasan: 'Garis singgung y = mx ± r√(1+m²) = 2x ± 5√(1+4) = 2x ± 5√5.',
      kesulitan: 'sedang',
      skor: 10,
      waktu: 120,
    },
    {
      id: 20,
      tipe: 'pilihan-ganda',
      pertanyaan: 'Titik (3,4) terletak pada lingkaran x²+y²=25. Garis singgung di titik ini tegak lurus garis lain. Gradien garis singgung tersebut adalah...',
      pilihan: ['4/3', '3/4', '−3/4', '−4/3'],
      jawabanBenar: 2,
      penjelasan: 'Persamaan garis singgung: 3x+4y=25. Gradien garis singgung = −3/4 (dari bentuk y = (−3/4)x + 25/4).',
      kesulitan: 'sedang',
      skor: 10,
      waktu: 120,
    },
    {
      id: 21,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Sebuah roda sepeda memiliki jari-jari 35 cm. Roda tersebut menyentuh jalan datar di satu titik. Analisislah: (a) Gambarkan dan jelaskan hubungan antara garis singgung (jalan) dan jari-jari roda di titik sentuh, (b) Tentukan persamaan garis singgung roda jika pusat roda berada di titik O(0,35) pada sistem koordinat dan jalan berada di sumbu-x, (c) Jika roda bergerak 5 putaran, berapa jarak yang ditempuh? Gunakan π = 22/7. Jelaskan pemahamanmu!',
      pilihan: [],
      jawabanBenar: -1,
      penjelasan: '(a) Garis singgung (jalan) tegak lurus jari-jari di titik sentuh, membentuk sudut 90°. (b) Pusat O(0,35), jalan y=0 adalah garis singgung karena jaraknya dari pusat = 35 = r. (c) Keliling = 2 × (22/7) × 35 = 220 cm. 5 putaran = 5 × 220 = 1100 cm = 11 m.',
      kesulitan: 'sulit',
      skor: 25,
      waktu: 600,
    },
    {
      id: 22,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Diketahui lingkaran L: x² + y² = 25 dan titik P(7, 1) di luar lingkaran. Selesaikan dan jelaskan: (a) Tunjukkan bahwa P berada di luar lingkaran, (b) Hitung panjang garis singgung dari P ke lingkaran L, (c) Mengapa dua garis singgung dari titik luar memiliki panjang yang sama? Berikan pembuktian logismu! (d) Bagaimana cara mencari titik singgungnya?',
      pilihan: [],
      jawabanBenar: -1,
      penjelasan: '(a) 7²+1²=50>25, P di luar lingkaran. (b) Panjang = √(49+1-25) = √25 = 5. (c) Karena segitiga OTP dan OTP’ kongruen (OT=OT’=r, OP bersama, sudut OTP=OTP’=90°), maka TP=TP’. (d) Substitusi persamaan garis melalui P ke persamaan lingkaran.',
      kesulitan: 'sulit',
      skor: 25,
      waktu: 600,
    },
...
\u2022 Garis singgung tidak memiliki dua titik yang terletak di dalam lingkaran.`,
    ...
    contoh: [
      {
        soal: 'Sebuah antena menara berbentuk lingkaran memiliki persamaan x² + y² = 169 (dalam satuan meter). Teknisi perlu memasang kabel lurus yang menyinggung menara di titik A(5, 12). Analisislah: (a) Verifikasi bahwa titik A(5, 12) benar-benar terletak pada lingkaran, (b) Tentukan persamaan kabel (garis singgung) di titik A, (c) Di titik manakah kabel tersebut memotong sumbu-x dan sumbu-y? (d) Mengapa garis singgung harus tegak lurus jari-jari di titik singgung?',
        solusi: [
          '(a) Verifikasi: 5² + 12² = 25 + 144 = 169 = r². Terbukti A(5,12) ada pada lingkaran.',
          '(b) Gunakan rumus garis singgung: x₁x + y₁y = r²',
          '5x + 12y = 169',
          'Jadi persamaan kabel adalah 5x + 12y = 169',
          '(c) Potong sumbu-x (y=0): 5x = 169 → x = 33,8 → titik (33,8 ; 0)',
          'Potong sumbu-y (x=0): 12y = 169 → y ≈ 14,08 → titik (0 ; 14,08)',
          '(d) Karena jika tidak tegak lurus, garis akan memotong lingkaran di dua titik (bukan menyinggung). Tegak lurus memastikan garis hanya menyentuh satu titik.',
        ],
      },
      {
        soal: 'Diketahui titik P(8, 6) berada di luar lingkaran L: x² + y² = 25. Dua garis singgung ditarik dari P menyinggung lingkaran di titik A dan B. Seorang siswa mengklaim panjang PA = PB = 9 satuan. Evaluasilah klaim tersebut: (a) Tunjukkan bahwa P berada di luar lingkaran, (b) Hitung panjang garis singgung dari P ke lingkaran, (c) Apakah klaim siswa benar? Berikan argumenmu! (d) Jelaskan mengapa dua garis singgung dari titik luar selalu sama panjang.',
        solusi: [
          '(a) Substitusi P(8,6): 8² + 6² = 64 + 36 = 100 > 25. Jadi P berada di luar lingkaran.',
          '(b) Panjang garis singgung = √(x₀² + y₀² - r²) = √(64 + 36 - 25) = √75 = 5√3 ≈ 8,66 satuan',
          '(c) Klaim siswa (PA = PB = 9) SALAH. Nilai yang benar adalah 5√3 ≈ 8,66, bukan 9.',
          '(d) Bukti: Segitiga OPA dan OPB kongruen karena OA = OB = r (jari-jari), OP sama, dan ∠OAP = ∠OBP = 90° (garis singgung ⊥ jari-jari). Dari kongruensi (RHS), maka PA = PB.',
        ],
      },
    ],
  },
