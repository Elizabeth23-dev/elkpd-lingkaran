...
export const soalPerTopik: Record<string, SoalItem[]> = {
  ...
  'lingkaran-garis-singgung': [
    ...
    },
    {
      id: 21,
      tipe: 'berpikir-kritis',
      pertanyaan: 'Roda sebuah kereta berjari-jari 50 cm menyentuh rel di titik T.\n\na. Apa inti pertanyaan dari situasi roda dan rel ini? Jelaskan apa yang perlu dibuktikan!\n\nb. Amati hubungan antara jari-jari OT dan permukaan rel di titik T. Apa yang dapat kamu simpulkan dari pengamatan tersebut?\n\nc. Mengapa rel hanya menyentuh roda di SATU titik? Gunakan definisi garis singgung untuk mendukung kesimpulanmu!\n\nd. Apa perbedaan antara garis singgung dan garis potong (sekans)? Jelaskan asumsi mana yang berlaku pada kasus roda dan rel!\n\ne. Seorang teman berpendapat bahwa roda dan rel bersentuhan di dua titik agar kereta lebih stabil. Evaluasilah pendapat ini — apakah benar atau salah? Tentukan tindakan paling tepat untuk meluruskan pendapat tersebut!',
      pilihan: [],
      jawabanBenar: -1,
      penjelasan: '(a) Inti: membuktikan bahwa rel berfungsi sebagai garis singgung roda dan menganalisis hubungan jari-jari OT dengan rel.\n(b) Jari-jari OT tegak lurus (90°) terhadap permukaan rel di titik T — jarak terpendek dari pusat O ke garis rel adalah r = OT.\n(c) Rel hanya menyentuh roda di satu titik karena definisi garis singgung adalah garis yang memiliki tepat satu titik persekutuan dengan lingkaran. Jika ada dua titik sentuhan, rel menjadi garis potong yang memotong roda — tidak mungkin secara fisik.\n(d) Garis singgung: 1 titik persekutuan; garis potong: 2 titik persekutuan. Pada roda dan rel berlaku asumsi garis singgung.\n(e) Pendapat SALAH. Dua titik sentuhan menjadikan rel sebagai garis potong yang memotong lingkaran roda — secara fisik roda akan terbenam ke dalam rel. Satu titik sentuh memungkinkan roda menggelinding bebas.',
      kesulitan: 'sulit',
      skor: 25,
      waktu: 480,
    },
    {
      ...
      pilihan: [],
      jawabanBenar: -1,
      penjelasan: '(a) Inti: menghitung PA dan membuktikan PA = PB, serta menjelaskan mengapa titik dalam lingkaran tidak dapat membuat garis singgung.\n(b) Sifat garis singgung ⊥ jari-jari dan teorema Pythagoras adalah sumber paling relevan.\n(c) ∠OAP = 90°. PA² = OP² - OA² = 13² - 5² = 169 - 25 = 144. PA = 12 cm.\n(d) Generalisasi: dua garis singgung dari satu titik luar SELALU sama panjang. Bukti: segitiga OAP ≅ OBP (OA = OB = r, OP bersama, ∠OAP = ∠OBP = 90°, kriteria RHS) → PA = PB = 12 cm. Klaim siswa SALAH.\n(e) Jika P di dalam lingkaran maka OP < r, sehingga PT² = OP² - r² < 0 (negatif) → tidak ada panjang nyata. Kesimpulan: garis singgung dari titik dalam lingkaran tidak mungkin ada.',
      kesulitan: 'sulit',
      skor: 25,
      waktu: 480,
    },
...
di mana \u03b1 adalah besar sudut pusat (dalam derajat) dan r adalah jari-jari lingkaran.`
    ...
    contoh: [
      {
        soal: 'Sebuah sprinkler (alat penyiram) air berputar membentuk sudut pusat 120° dan menjangkau jarak 14 meter. Seorang petani ingin mengetahui apakah luas lahan yang disiram sudah mencukupi 600 m².\n\na. Apa inti permasalahan yang ingin diselesaikan petani? Identifikasi dengan jelas apa yang perlu dihitung!\n\nb. Tuliskan semua data yang tersedia dari situasi sprinkler ini. Data mana yang paling krusial untuk memulai perhitungan?\n\nc. Hitunglah: (1) Panjang busur jangkauan sprinkler, (2) Luas juring yang disiram. Gunakan π = 22/7.\n\nd. Mengapa area yang disiram berbentuk juring, bukan lingkaran penuh? Jelaskan konsep sudut pusat yang mendasarinya!\n\ne. Luas yang disiram tidak mencukupi 600 m². Tentukan strategi paling efisien: apakah sudut pusat atau jangkauan (jari-jari) yang perlu ditingkatkan? Berikan alasan matematis!',
        solusi: [
          '(a) Inti masalah: menghitung panjang busur dan luas juring yang dicakup sprinkler, lalu membandingkan apakah luas juring ≥ 600 m².',
          '(b) Data: α = 120° (sudut pusat), r = 14 m (jangkauan sprinkler), π = 22/7. Data paling krusial: sudut pusat dan jari-jari, karena keduanya menentukan besar juring.',
          '(c) (1) Panjang busur = (α/360°) × 2πr = (120/360) × 2 × (22/7) × 14 = (1/3) × 88 = 29,33 m',
          '(2) Luas juring = (α/360°) × πr² = (120/360) × (22/7) × 196 = (1/3) × 616 = 205,33 m²',
          '(d) Area disiram berbentuk juring karena sprinkler berputar dari titik pusat (O) membentuk sudut 120°, dibatasi dua jari-jari dan busur. Lingkaran penuh hanya terjadi jika sudut pusat = 360°.',
          '(e) Meningkatkan jari-jari lebih efisien: luas juring ∝ r² (kuadratik), sedangkan luas ∝ α hanya linear. Contoh: jika r = 21 m → luas = (1/3) × (22/7) × 441 = 462 m². Jika α = 180° dengan r = 14 m → luas = (1/2) × 616 = 308 m² (masih kurang). Jadi tingkatkan jangkauan (r) lebih optimal.',
        ],
      },
    ],
  },
    ...
    contoh: [
      {
        ...
        solusi: [
          ...
          '(b) Fakta geometris: (1) Roda berbentuk lingkaran dengan r = 28 cm dan pusat O. (2) Jalan menyentuh roda di titik T saja. (3) OT adalah jari-jari menuju titik sentuh T. (4) OT ⊥ jalan (sudut 90°) — jarak terpendek dari O ke garis jalan.',
          '(c) Definisi garis singgung: garis yang memiliki tepat satu titik persekutuan dengan lingkaran. Jalan menyentuh roda hanya di T → jalan adalah garis singgung. Jika jalan memotong roda di dua titik, jalan menjadi garis potong → sebagian roda terbenam ke dalam jalan — mustahil secara fisik.',
          '(d) Garis singgung: 1 titik persekutuan, tegak lurus jari-jari di titik itu. Garis potong (sekans): 2 titik persekutuan, memotong lingkaran. Asumsi yang berlaku: garis singgung — karena roda menggelinding di atas permukaan, bukan terbenam ke dalamnya.',
          '(e) Pendapat teman SALAH. Dua titik sentuhan → jalan jadi garis potong → roda terbenam ke jalan (tidak mungkin). Argumen paling efektif: PT² = OP² − r². Jika OP = r (tepat menyentuh), PT = 0. Jika dua titik sentuhan, OP < r → titik P di dalam roda — mustahil secara fisik.',
        ],
      },
    ],
  },
